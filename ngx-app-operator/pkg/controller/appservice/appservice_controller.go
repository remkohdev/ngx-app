...
import (
	...
	ngxappv1alpha1 "github.com/remkohdev/ngx-app/pkg/apis/ngxapp/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &ngxappv1alpha1.AppService{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &ngxappv1alpha1.AppService{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &ngxappv1alpha1.AppService{}
...
func newPodForCR(cr *ngxappv1alpha1.AppService) *corev1.Pod {
